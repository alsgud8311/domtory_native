import { Image, StyleSheet, View, Text, Button, TouchableOpacity, Linking, Alert, } from "react-native";
...
export default function Shortcuts({ navigation }) {
    ...
    onPress={() => openBrowserAsync("http://www.cbhs2.kr/main")}>
        ...
        <TouchableOpacity style={styles.buttonWrapper} onPress={() => openBrowserAsync("http://1.246.219.13:8080/cbhs/indexstdds.html?var1=M000004116")}>
    ...
    onPress={() => navigation.navigate("공지사항", { div: "cbhs" })}>
        ...
        <TouchableOpacity style={styles.buttonWrapper} onPress={() => openBrowserAsync("http://1.246.219.13:8080/cbhs/indexstdds.html?var1=M000004115")}>
          <Image style={styles.buttons} source={tools}/>
          <Text>보수요청</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.buttonWrapper} onPress={() => openBrowserAsync("http://www.cbhs2.kr/0000038")}>
