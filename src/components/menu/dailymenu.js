...
export default function Menucard({ selectedDate }) {
    ...
    useEffect(() => {
        (() => __awaiter(this, void 0, void 0, function* () {
            const data = yield getBreakMenuData(convertDateToCustomFormat(selectedDate));
    ...
    useEffect(() => {
        (() => __awaiter(this, void 0, void 0, function* () {
            const data = yield getLunchMenuData(convertDateToCustomFormat(selectedDate));
    ...
    useEffect(() => {
        (() => __awaiter(this, void 0, void 0, function* () {
            const data = yield getDinnerMenuData(convertDateToCustomFormat(selectedDate));
        ...
        <View style={styles.card}>
          <View>
            <View style={styles.mealWrapper}>
              ...
              {breakData ? (breakData.map((item, index) => (<Text key={index} style={styles.mealText}>
                    {item}
                  </Text>))) : (<Text style={styles.mealText}>식단 정보가 없습니다.</Text>)}
            </View>
          </View>
        </View>
      </View>
        ...
        <View style={styles.card}>
          <View>
            <View style={styles.mealWrapper}>
              ...
              {lunchData ? (lunchData.map((item, index) => (<Text key={index} style={styles.mealText}>
                    {item}
                  </Text>))) : (<Text style={styles.mealText}>식단 정보가 없습니다.</Text>)}
            </View>
          </View>
        ...
        <View style={styles.card}>
          <View>
            <View style={styles.mealWrapper}>
              ...
              {dinnerData ? (dinnerData.map((item, index) => (<Text key={index} style={styles.mealText}>
                    {item}
                  </Text>))) : (<Text style={styles.mealText}>식단 정보가 없습니다.</Text>)}
            </View>
          </View>
