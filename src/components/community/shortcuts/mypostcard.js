...
export default function MyPostCard({ navigation }) {
    return (<View style={styles.container}>
      ...
      <TouchableOpacity style={styles.shortcutButton} onPress={() => navigation.navigate("내가 스크랩한 글")}>
        <FontAwesome5 name="bookmark" size={24} color="black"/>
        <Text style={styles.sortcutText}>내가 스크랩한 글</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.shortcutButton} onPress={() => navigation.navigate("내가 쓴 글")}>
        <MaterialCommunityIcons name="comment-account-outline" size={24} color="black"/>
        <Text style={styles.sortcutText}>내가 쓴 글</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.shortcutButton} onPress={() => navigation.navigate("내가 쓴 댓글")}>
